...
eadk_color_t palette_original[4] = {eadk_color_white, 0xad55, 0x52aa, eadk_color_black};
eadk_color_t palette_yellow[4] = {0xff70, 0xbc08, 0x6124, eadk_color_black};
eadk_color_t palette_light[4] = {0xaff1, 0x450e, 0x1249, eadk_color_black};
eadk_color_t palette_blue[4] = {0x871c, 0x53d5, 0x310c, eadk_color_black};
eadk_color_t palette_pink[4] = {0xfe38, 0xbb72, 0x594c, eadk_color_black};
eadk_color_t palette_virtual[4] = {0xfb65, 0xa904, 0x6047, eadk_color_black};
